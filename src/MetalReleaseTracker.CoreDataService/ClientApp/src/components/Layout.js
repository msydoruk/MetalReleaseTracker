...
const NAV_ITEMS = [
  ...
  { label: 'Currencies', path: '/currencies', icon: <CurrencyExchangeIcon /> },
  { label: 'Navigation', path: '/navigation', icon: <NavigationIcon /> },
  { label: 'Translations', path: '/translations', icon: <TranslateIcon /> },
