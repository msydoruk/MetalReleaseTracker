...
public class WerewolfParserSmokeTests : ParserSmokeTestBase
{
    ...
    private static WerewolfParser CreateParser()
    {
        ...
        return new WerewolfParser(
            documentLoader,
            CreateSettingsService(),
            NullLogger<WerewolfParser>.Instance);
    }
    ...
    public async Task ParseAlbumDetail_SingleProduct_ReturnsPopulatedFields()
    {
        ...
        AssertAlbumDetailValid(album, DistributorCode.Werewolf);
    }
